...
import { projects, projects23_24, projects22_23, projects21_22, projects20_21, projects19_20, projects18_19 } from '../components/ProjectHelper.js';
...
const Projects = () => {
    ...
    <div className="projects-container">
      ...
      <h1 className="page-title" id="2023-2024">2023-2024 projects</h1>
      ...
      {/* 2022-2023 projects */ }
    <hr className="centered-line" />
      <h1 className="page-title" id="2022-2023">2022-2023 projects</h1>
      ...
      {/* 2021-2022 projects */ }
      <hr className="centered-line" />
      <h1 className="page-title" id="2021-2022">2021-2022 projects</h1>
      ...
      {/* 2020-2021 projects */ }
            <hr className="centered-line" />
      <h1 className="page-title" id="2018-2021">2020-2021 projects</h1>
      <div className="showcase-recording-button">
      <Link 
