...
import { Link } from "react-router-dom"; // CRA routing
    ...
    <main>
      ...
      <section className="video-section">
        ...
        <div className="overlay">
          ...
          <p>
            A community of students bringing <br />
            their wildest ideas to life.
          </p>
          <img src={mhiImage} alt="USC Ming Hsieh Institute" />
        </div>
      </section>
      ...
      <div className="learn-more-button">
        <Link to="/about" className="learn-more-button-details">
          learn more!
        </Link>
      </div>
